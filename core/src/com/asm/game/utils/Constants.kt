...
object Constants {
    ...
    const val FATAL_OBSTACLE_PHYSICS_TAG = 0x0005
    const val COIN_PHYSICS_TAG = 0x0006
    const val NONFATAL_OBSTACLE_PHYSICS_TAG = 0x0007
    const val SPAWNER_TARGET_TIME = 1500000000L
    const val SPEEDUPDATE_TARGET_TIME = 5000000000L
    const val GRAVITY_INTERVAL = 10000000000L
    const val PUSH_FORCE = 200f
}