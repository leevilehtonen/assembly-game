...
class Coin(body: Body, texture: TextureRegion, speed: Float, val animation: CoinAnimation, val spawner: Spawner) : PhysicsGameObject(body, texture, speed) {
    val value:Int = 1
    var coinStateTime: Float = 0f
    ...
    override fun update(delta: Float) {
        ...
        coinStateTime += delta
        sprite.setRegion(animation.coinAnimation.getKeyFrame(coinStateTime, true))
    }
